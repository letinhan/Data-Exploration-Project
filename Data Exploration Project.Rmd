...
trends <- do.call("rbind", list(trends_Yorktown, trends_UTMB, trends_UT, trends_UPhoenix, trends_UM, trends_inter_6, trends_inter_5, trends_inter_4, trends_inter_3, trends_inter_2, trends_inter_1, trends_finish))
...
# Grouping the Google Trends Data by month and college v
new_df<- df %>%
